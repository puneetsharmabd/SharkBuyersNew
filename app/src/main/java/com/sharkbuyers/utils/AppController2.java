...
public class AppController2 {
    ...
    private static final String SETTINGS_NAME = "default_settings2";
    private static AppController2 sSharedPrefs;
    ...
    public static AppController2 getInstance(Context context) {
        if (sSharedPrefs == null) {
            sSharedPrefs = new AppController2(context.getApplicationContext());
        }
        return sSharedPrefs;
    }

    public static AppController2 getInstance() {
        if (sSharedPrefs != null) {
            return sSharedPrefs;
        }
